...
enum serverCode { SEND_SERVER_INIT, SEND_SERVER_DECK, SEND_SERVER_STARTGAME, SEND_SERVER_DRAWCARD, SEND_SERVER_ENDGAME, SEND_SERVER_FADECARD, SEND_SERVER_PLAYCARD, SEND_SERVER_READINFO};
